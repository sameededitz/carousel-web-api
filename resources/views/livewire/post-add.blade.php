        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h6 class="card-title mb-0">Add Blog</h6>
                </div>
                <div class="card-body">
                    <form wire:submit.prevent="store" enctype="multipart/form-data">
                        <div class="row gy-3">
                            <div class="col-md-12">
                                ...
                                <x-filepond::upload wire:model.live="image" multiple allowImageValidateSize="true"
                                    maxFileSize="20MB" allowFileTypeValidation="true"
                                    acceptedFileTypes="image/jpeg, image/png, image/jpg" />
                                @error('image')
                                    <!-- Updated to match the wire:model -->
