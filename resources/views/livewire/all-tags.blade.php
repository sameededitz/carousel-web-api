<div>
            ...
            <div class="card basic-data-table">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <button type="button" class="btn rounded-pill btn-outline-info-600 radius-8 px-20 py-11"
                        data-bs-toggle="modal" data-bs-target="#tagModal" wire:click="resetForm">Add Tag</button>
                </div>
                <div class="card-body scroll-sm" style="overflow-x: scroll">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <button  wire:click="editTag({{ $tag->id }})" data-bs-toggle="modal" data-bs-target="#tagModal"
                                                    class="w-32-px h-32-px bg-success-focus text-success-main rounded-circle d-inline-flex align-items-center justify-content-center">
                                                    <iconify-icon icon="mdi:pencil"></iconify-icon>
                                                </button>
                                                <button wire:click="$js.confirmDelete({{ $tag->id }})"
                    ...
                    <div class="mt-24">
                        {{ $tags->links('components.pagination',data: ['scrollTo' => '#paginated-table']) }}
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="tagModal" wire:ignore.self tabindex="-1" aria-labelledby="tagModal" aria-hidden="true">
        <div class="modal-dialog modal-dialog modal-dialog-centered">
            <div class="modal-content radius-16 bg-base">
                ...
                <div class="modal-body p-24">
                    <form wire:submit.prevent="{{ $isEdit ? 'updateTag' : 'saveTag' }}">
                        <div class="row">
                            <div class="col-12 mb-20">
                                ...
                                <input type="text" name="name" class="form-control input-form-dark radius-8"
                                    placeholder="Enter Tag Name" wire:model.defer="name" required>
                                @error('name')
